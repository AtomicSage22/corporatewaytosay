...
import { useCallback, useEffect, useRef, useState } from "react";import { Box, FormLabel, Input } from "@mui/material";
...
const SearchBox = ({ search, setSearch, onSubmit, placeholders }) => {
  ...
  return (
    <Box className=" h-[100px] flex justify-center items-center">
